function verifyWorkbook_(ss) {
  ...
  const report = {
    ...
    dashboardLabels: dashboard.getRange('A4:I4').getDisplayValues()[0],
    dashboardValues: dashboard.getRange('A5:I5').getDisplayValues()[0],
    dashboardFormulas: dashboard.getRange('A5:I5').getFormulas()[0],
